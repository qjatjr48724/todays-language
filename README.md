...
<img src="docs/images/screens/첫화면.PNG" width="280" alt="첫 화면" />
...
<p>
  <img src="docs/images/screens/알림권한.PNG" width="280" alt="알림 권한" />
  <img src="docs/images/screens/알림권한2.PNG" width="280" alt="알림 권한 거부 후 안내" />
</p>
...
<img src="docs/images/screens/로그인방식선택.PNG" width="280" alt="로그인 방식 선택" />

이메일 로그인 진입 화면입니다. (Google·Apple 소셜 로그인은 보안 검토 후 추가 예정, 현재 UI 비활성)

#### 이메일 로그인

<img src="docs/images/screens/이메일로그인화면.PNG" width="280" alt="이메일 로그인" />
...
<img src="docs/images/screens/첫실행-로컬언어선택.PNG" width="280" alt="로컬 언어 선택" />

온보딩 1단계: 모국어(로컬 언어)를 선택합니다.

#### 학습 언어·난이도

<img src="docs/images/screens/첫실행-대상언어선택.PNG" width="280" alt="학습 언어·난이도" />
...
<img src="docs/images/screens/홈화면.PNG" width="280" alt="홈" />
...
<p>
  <img src="docs/images/screens/내정보.PNG" width="280" alt="내 정보" />
  <img src="docs/images/screens/내정보-언어선택.PNG" width="280" alt="내 정보 언어 선택" />
  <img src="docs/images/screens/내정보-학습난이도.PNG" width="280" alt="내 정보 학습 난이도" />
</p>
...
<img src="docs/images/screens/커뮤니티.PNG" width="280" alt="커뮤니티" />
...
<p>
  <img src="docs/images/screens/진행률.PNG" width="280" alt="진행률" />
  <img src="docs/images/screens/진행률-날짜클릭.PNG" width="280" alt="진행률 날짜 상세" />
</p>
...
<img src="docs/images/screens/오늘의단어.PNG" width="280" alt="오늘의 단어" />

일일 단어 30개를 학습하고 예문을 확인합니다.

#### 오늘의 문장

<img src="docs/images/screens/오늘의문장.PNG" width="280" alt="오늘의 문장" />

일일 문장 10개를 학습합니다.

#### 오늘의 마무리

<img src="docs/images/screens/오늘의마무리.PNG" width="280" alt="오늘의 마무리" />
...
<p>
  <img src="docs/images/screens/기초문자표-영어.PNG" width="280" alt="기초 문자표 영어" />
  <img src="docs/images/screens/기초문자표-한국어.PNG" width="280" alt="기초 문자표 한국어" />
  <img src="docs/images/screens/기초문자표-일본어%28히라%29.PNG" width="280" alt="기초 문자표 일본어" />
</p>
