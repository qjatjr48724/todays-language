...
- (미구현)채팅 : 같은 언어를 선택한 사용자끼리 대화하며 회화 능력을 기를 수 있다.
- (미구현)언어별 자격증 : 언어별로 취득할 수 있는 자격증의 정보를 확인하고, 서로 자신만의 공부 팁을 공유할 수 있는 커뮤니티.
- (미구현)기본 회화 가이드 : 외국어 실력이 완벽하지 않아도 해외에서 참고할 수 있도록 하는 회화 가이드.
...
> 스크린샷 원본: `docs/images/screens/` · 각 화면은 **제목 → 사진(가운데) → 설명** 순서입니다.
> GitHub README는 **HTML 표의 너비·정렬 CSS를 거의 적용하지 않습니다.** 표 대신 아래 블록 구조를 사용합니다.
...
- 앱 실행 첫 화면입니다.
- 터치 또는 자동 전환 후 로그인·홈으로 이동합니다.

#### 알림 권한

<p align="center">
  <img src="docs/images/screens/알림권한.PNG" width="240" alt="알림 권한" />
  <img src="docs/images/screens/알림권한2.PNG" width="240" alt="알림 권한 거부 후 안내" />
</p>

- 최초 실행 시 알림 허용을 안내합니다.
- 거부 시 설정 앱으로 안내하는 흐름을 포함합니다.
...
<p align="center">
  <img src="docs/images/screens/이메일%20회원가입.PNG" width="240" alt="이메일 회원가입" />
</p>

- 약관 동의 후 이메일·비밀번호로 회원가입합니다.
...
- 오늘의 단어·문장·마무리·기초 문자표로 진입합니다.
- 일일 진행률을 한눈에 확인합니다.

#### 내 정보

<p align="center">
  <img src="docs/images/screens/내정보.PNG" width="240" alt="내 정보" />
  <img src="docs/images/screens/내정보-언어선택.PNG" width="240" alt="내 정보 언어 선택" />
  <img src="docs/images/screens/내정보-학습난이도.PNG" width="240" alt="내 정보 학습 난이도" />
</p>

- 학습 언어·난이도 변경 및 로그아웃을 제공합니다.
- 언어 선택·난이도 변경 화면으로 이동할 수 있습니다.
...
<p align="center">
  <img src="docs/images/screens/진행률.PNG" width="240" alt="진행률" />
  <img src="docs/images/screens/진행률-날짜클릭.PNG" width="240" alt="진행률 날짜 상세" />
</p>

- 오늘 진행률과 월간 캘린더를 확인합니다.
- 날짜를 선택하면 해당 일의 학습 상세를 확인합니다.
...
<p align="center">
  <img src="docs/images/screens/기초문자표-영어.PNG" width="240" alt="기초 문자표 영어" />
  <img src="docs/images/screens/기초문자표-한국어.PNG" width="240" alt="기초 문자표 한국어" />
  <img src="docs/images/screens/기초문자표-일본어%28히라%29.PNG" width="240" alt="기초 문자표 일본어" />
</p>
