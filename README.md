...
스크린샷 원본: `docs/images/screens/` · 각 행은 **사진(위) → 설명(아래)** 순서입니다.

### 1) 앱 진입

| 화면 | 스크린샷 · 설명 |
|:---|:---|
| **첫 화면** | <img src="docs/images/screens/첫화면.PNG" width="240" alt="첫 화면" /><br><br>앱 실행 첫 화면. 터치 또는 자동 전환 후 로그인·홈으로 이동합니다. |
| **알림 권한** | <img src="docs/images/screens/알림권한.PNG" width="240" alt="알림 권한" /> <img src="docs/images/screens/알림권한2.PNG" width="240" alt="알림 권한 거부 후 안내" /><br><br>최초 실행 시 알림 허용 안내. 거부 시 설정 앱으로 안내하는 흐름을 포함합니다. |

### 2) 로그인·회원가입

| 화면 | 스크린샷 · 설명 |
|:---|:---|
| **로그인 방식 선택** | <img src="docs/images/screens/로그인방식선택.PNG" width="240" alt="로그인 방식 선택" /><br><br>이메일 로그인 진입 화면입니다. (Google·Apple 소셜 로그인은 보안 검토 후 추가 예정, 현재 UI 비활성) |
| **이메일 로그인** | <img src="docs/images/screens/이메일로그인화면.PNG" width="240" alt="이메일 로그인" /><br><br>이메일·비밀번호로 로그인합니다. |

### 3) 온보딩 (첫 진입)

| 화면 | 스크린샷 · 설명 |
|:---|:---|
| **로컬 언어 선택** | <img src="docs/images/screens/첫실행-로컬언어선택.PNG" width="240" alt="로컬 언어 선택" /><br><br>온보딩 1단계: 모국어(로컬 언어)를 선택합니다. |
| **학습 언어·난이도** | <img src="docs/images/screens/첫실행-대상언어선택.PNG" width="240" alt="학습 언어·난이도" /><br><br>온보딩 2단계: 학습할 대상 언어와 난이도를 선택합니다. |

### 4) 메인 (하단 탭)

| 화면 | 스크린샷 · 설명 |
|:---|:---|
| **홈** | <img src="docs/images/screens/홈화면.PNG" width="240" alt="홈" /><br><br>오늘의 단어·문장·마무리·기초 문자표로 진입하고, 일일 진행률을 한눈에 확인합니다. |
| **내 정보** | <img src="docs/images/screens/내정보.PNG" width="240" alt="내 정보" /> <img src="docs/images/screens/내정보-언어선택.PNG" width="240" alt="내 정보 언어 선택" /> <img src="docs/images/screens/내정보-학습난이도.PNG" width="240" alt="내 정보 학습 난이도" /><br><br>학습 언어·난이도 변경 및 로그아웃. 언어 선택·난이도 변경 화면으로 이동할 수 있습니다. |
| **커뮤니티** | <img src="docs/images/screens/커뮤니티.PNG" width="240" alt="커뮤니티" /><br><br>커뮤니티 탭입니다. (기능 확장 예정) |
| **진행률** | <img src="docs/images/screens/진행률.PNG" width="240" alt="진행률" /> <img src="docs/images/screens/진행률-날짜클릭.PNG" width="240" alt="진행률 날짜 상세" /><br><br>오늘 진행률과 월간 캘린더. 날짜를 선택하면 해당 일의 학습 상세를 확인합니다. |

### 5) 학습·참고

| 화면 | 스크린샷 · 설명 |
|:---|:---|
| **오늘의 단어** | <img src="docs/images/screens/오늘의단어.PNG" width="240" alt="오늘의 단어" /><br><br>일일 단어 30개를 학습하고 예문을 확인합니다. |
| **오늘의 문장** | <img src="docs/images/screens/오늘의문장.PNG" width="240" alt="오늘의 문장" /><br><br>일일 문장 10개를 학습합니다. |
| **오늘의 마무리** | <img src="docs/images/screens/오늘의마무리.PNG" width="240" alt="오늘의 마무리" /><br><br>단어·문장 학습 완료 후 4지선다로 오늘 학습을 점검합니다. |
| **기초 문자표** | <img src="docs/images/screens/기초문자표-영어.PNG" width="240" alt="기초 문자표 영어" /> <img src="docs/images/screens/기초문자표-한국어.PNG" width="240" alt="기초 문자표 한국어" /> <img src="docs/images/screens/기초문자표-일본어%28히라%29.PNG" width="240" alt="기초 문자표 일본어" /><br><br>학습 언어에 맞는 알파벳·한글·히라가나 등 참고 차트를 제공합니다. |
