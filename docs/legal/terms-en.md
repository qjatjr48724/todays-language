...
<!-- nisrulz Markdown export 내용을 아래에 붙여넣으세요 -->
...
The Application includes language chat rooms where registered users may post text messages visible to other users learning the same target language. When you use these features, you agree not to post content that:
...
*   Moderate, filter, or hide chat messages that violate these Terms, applicable law, or the guidelines set out above

Messages you post in a language chat room may be visible to other registered users in that room.

If you believe content violates these Terms, infringes your rights, or is unlawful, you may report it to the Service Provider at qjatjr1285@naver.com. The report should include enough information for the Service Provider to identify the content, evaluate the complaint, and contact you if follow-up is required.

The Service Provider may review reported content, request additional information where necessary, remove or restrict access to content, and take action against the responsible account where appropriate. Users affected by moderation decisions may contact the Service Provider at qjatjr1285@naver.com to request further review. The Service Provider will respond to appeals within a reasonable period and provide the reasons for any upheld moderation decision, subject to applicable law.

By submitting messages in chat rooms, you grant the Service Provider a non-exclusive, worldwide, royalty-free license to use, reproduce, distribute, prepare derivative works of, display and perform the content in connection with operating the Application. This license does not grant the Service Provider the right to sell or sublicense your content to third parties independently of the Application. You represent and warrant that you own or control all rights in the content you post and that use of the content does not violate these Terms or applicable law.

Your messages may include personal data (for example, display name). Processing of personal data related to chat messages is governed by the Privacy Policy. Do not post personal data of others without their consent.
...
*   [Google Firebase](https://firebase.google.com/terms) (Authentication, Cloud Firestore, Cloud Functions, Analytics, Crashlytics, and Storage where used)
*   [Google Analytics for Firebase](https://www.google.com/analytics/terms/)
*   [Firebase Crashlytics](https://firebase.google.com/terms/crashlytics)
*   [OpenAI](https://openai.com/policies/terms-of-use/) (server-side learning content generation only; no API key in the app)
...
The Application incorporates Artificial Intelligence (AI) technologies to provide learning content. AI processing runs on the Service Provider's servers (Cloud Functions) using OpenAI. AI-generated content is for language practice only and may contain errors. The Service Provider does not guarantee the accuracy or completeness of AI-generated content.
...
If the Application qualifies as an intermediary service under the Digital Services Act (Regulation (EU) 2022/2065, "DSA"), the following provisions apply in addition to the terms above.

Point of Contact: The Service Provider maintains a single point of contact for direct communication with EU authorities and recipients of the service, reachable at qjatjr1285@naver.com. The Service Provider has not designated an EU legal representative under Article 13 of the DSA.

Content Moderation: When the Service Provider removes chat messages, suspends or terminates an account, or otherwise limits access to the Application, the Service Provider will provide a clear statement of reasons where required by applicable law, including the nature of the restriction and information on how to contact the Service Provider.

Notice and Action: Users and third parties may submit notices of allegedly illegal content in chat rooms through qjatjr1285@naver.com. The Service Provider will review notices and respond without undue delay where required by applicable law.

These DSA provisions apply to the extent required for the Application and do not replace or limit any rights or obligations under applicable consumer protection or data protection law.
...
If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at qjatjr1285@naver.com.
