...
This privacy policy is applicable to the Today's Language app for mobile devices, together with any related services operated by seok77 (collectively, the "Application"). seok77 is hereinafter referred to as the "Service Provider".

**Data Controller Information**

seok77 acts as the Data Controller responsible for the processing of your personal data.

*   Name: seok77
*   Address: 1-1 Sinhyeon-ro 37beon-gil, Seohae-gu, Incheon
*   Email: qjatjr1285@naver.com
...
The Application uses Artificial Intelligence (AI) on the Service Provider's servers (Google Cloud Functions) to generate daily learning content such as vocabulary and example sentences. **OpenAI** processes limited learning context on the Service Provider's behalf—for example, target language, difficulty level, and curriculum context needed to generate content. Your **email address and password are not sent to OpenAI**.

AI-generated content is provided for language practice only. It may contain errors and is not used to make decisions that produce legal or similarly significant effects concerning you.

**Do third parties see and/or have access to information obtained by the Application?**

The Service Provider uses trusted service providers to operate the Application. These providers may process personal data on the Service Provider's behalf as described in this privacy statement and under Data Processing Agreements where required by law.

**Service providers that process data on our behalf**

| Provider | Purpose | Data involved |
|----------|---------|---------------|
| **Google (Firebase)** | Authentication, Cloud Firestore database, Cloud Functions, Analytics, Crashlytics, and Storage (where used) | Account identifiers, profile and learning data, chat messages you post, device and diagnostic data |
| **OpenAI** | AI-generated learning content (server-side only; no API key in the app) | Target language, difficulty level, and minimal curriculum context for content generation—not your email or password |

Please note that the Application utilizes third-party services that have their own Privacy Policy about handling data. Below are links to the Privacy Policy of the third-party service providers used by the Application:
...
To request deletion of your personal data, withdraw consent, or exercise any of your rights, contact the Service Provider at qjatjr1285@naver.com.
...
To exercise any of these rights, please contact the Service Provider at qjatjr1285@naver.com. The Service Provider will verify your request using the information you provide and respond within the timeframes required by law. You may designate an authorized agent to make a request on your behalf.
...
If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at qjatjr1285@naver.com.
